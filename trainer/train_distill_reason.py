...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="RNewMind Distill Reasoning")
    ...
    args.wandb_run_name = f"RNewMind-Distill-Reasoning-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
